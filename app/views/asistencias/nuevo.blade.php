		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Asistencias <small> Registrar Asistencia de alumnos por Carrera</small>
					</h3>
					...
					<div class="portlet">
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="{{url('asistencias/listado')}}" {{ $disabled }} class="btn default blue-stripe" <?php if ($habilita == true) echo "disabled"; ?>>
								<i class="fa fa-plus"></i>
								<span class="hidden-480">
								Listado </span>
								</a>
...
@section('customjs')
	...
	function Inscripciones(activo) {
		...
		$.ajax({
		  ...
		  data:{'cboMaterias': materia_id, 'cboCarrera': carrera_id, 'cboPlan': planID, 'fechadesde': fechadesde, 'txtalumno': txtalumno},
		  type: 'POST'
