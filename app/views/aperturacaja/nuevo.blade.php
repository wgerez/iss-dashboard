		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="{{url('aperturacaja/crear')}}">Apertura de Caja</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
			...
			<div class="row">
				<div class="col-md-12">
					...
					{{ Form::open(array('url'=>'aperturacaja/guardar', 'class'=>'form-horizontal form-row-seperated', 'id'=>'FrmAperturaCaja', 'name'=>'FrmAperturaCaja'))}}
					<div class="portlet">
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="{{url('aperturacaja/crear')}}" class="btn default red-stripe">
						...
						<div class="portlet-body">
							<div class="form-body">
								<input type="hidden" value="" name="aperturacajaid" id="aperturacajaid">
								<div class="form-group @if ($errors->has('arqueo')) {{'has-error'}} @endif">
									...
									<div class="col-md-2 <?php if ($errors->has('arqueo')) echo 'has-error' ?>">
										<input type="text" class="form-control" id="arqueo" name="arqueo" value="{{ '000' . $aperturacajaid }}" style="text-align: center" disabled>
								...
								<div class="form-group @if ($errors->has('iniciocaja')) {{'has-error'}} @endif">
									...
									<div class="col-md-2 <?php if ($errors->has('iniciocaja')) echo 'has-error' ?>">
										...
										<input type="hidden" class="form-control" id="iniciocajas" name="iniciocajas" value="{{ Input::old('iniciocajas') }}">
								...
								<div class="form-group">
									...
									<div class="col-md-2 col-sm-2">
										<a class="btn blue-madison" id='BtnBuscarApertura'>
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad500')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad500" name="cantidad500" value="{{ Input::old('cantidad500') }}" placeholder="" style="text-align: center">
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad200')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad200" name="cantidad200" value="{{ Input::old('cantidad200') }}" placeholder="" style="text-align: center">
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad100')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad100" name="cantidad100" value="{{ Input::old('cantidad100') }}" placeholder="" style="text-align: center">
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad50')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad50" name="cantidad50" value="{{ Input::old('cantidad50') }}" placeholder="" style="text-align: center">
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad20')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad20" name="cantidad20" value="{{ Input::old('cantidad20') }}" placeholder="" style="text-align: center">
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad10')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad10" name="cantidad10" value="{{ Input::old('cantidad10') }}" placeholder="" style="text-align: center">
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad5')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad5" name="cantidad5" value="{{ Input::old('cantidad5') }}" placeholder="" style="text-align: center">
												...
												<td>
													<center>
														<div class="col-md-8 <?php if ($errors->has('cantidad2')) echo 'has-error' ?>">
															<input type="number" class="form-control" id="cantidad2" name="cantidad2" value="{{ Input::old('cantidad2') }}" placeholder="" style="text-align: center">
							...
							<div class="form-group @if ($errors->has('monedas')) {{'has-error'}} @endif">
								...
								<div class="col-md-4 <?php if ($errors->has('monedas')) echo 'has-error' ?>">
									<input type="number" class="form-control" id="monedas" name="monedas" value="0" placeholder="">
									@if ($errors->has('monedas'))
									    <span class="help-block">{{ $errors->first('monedas') }}</span>
								    @endif
								</div>
								<div class="col-md-2 col-sm-2">
									<a class="btn blue-madison" id='BtnBuscar' <?php if ($bandera == true) echo "disabled"; ?>>
							...
							<div class="form-group @if ($errors->has('totals')) {{'has-error'}} @endif">
								...
								<div class="col-md-4 <?php if ($errors->has('totals')) echo 'has-error' ?>">
									<input type="text" class="form-control" id="totals" name="totals" value="{{ Input::old('totals') }}" placeholder="" disabled>
