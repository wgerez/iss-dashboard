										...
										<div class="form-body">
											<div class="form-group <?php if ($errors->has('txttitular_id')) echo 'has-error' ?>">
												...
												<div class="col-md-4 col-sm-4">
													<input class="form-control" name="txttitular" id="txttitular" type="text" value="">
													<input class="form-control" name="txttitular_id" id="txttitular_id" type="hidden" value="{{ $titular_id }}">
												</div>
											...
											<div class="form-group <?php if ($errors->has('txtpropietario_id')) echo 'has-error' ?>">
												...
												<div class="col-md-4 col-sm-4">
													<input class="form-control" name="txtpropietario" id="txtpropietario" type="text" value="">
													<input class="form-control" name="txtpropietario_id" id="txtpropietario_id" type="hidden" value="{{ $provisorio_id }}">
												</div>
											...
											<div class="form-group <?php if ($errors->has('txtsuplente_id')) echo 'has-error' ?>">
												...
												<div class="col-md-4 col-sm-4">
													<input class="form-control" name="txtsuplente" id="txtsuplente" type="text" value="">
													<input class="form-control" name="txtsuplente_id" id="txtsuplente_id" type="hidden" value="{{ $suplente_id }}">
												</div>
											...
											<div class="form-group col-md-12 col-sm-12">
												...
												<div class="form-group">
													...
													<div class="col-md-1 col-sm-1">
														<input type="number" class="form-control" min="0" max="24" id="horaentrada" name="horaentrada" value="" <?php if ($horaentrada == '') echo "disabled"; ?>>
													</div>
													<div class="col-md-1 col-sm-1">
														<input type="number" class="form-control" min="0" max="59" id="minutoentrada" name="minutoentrada" value="" <?php if ($minutoentrada == '') echo "disabled"; ?>>
													</div>

													<label  class="col-md-2 col-sm-2 control-label">Hora Salida:</label>
													<div class="col-md-1 col-sm-1">
														<input type="number" class="form-control" min="0" max="24" id="horasalida" name="horasalida" value="" <?php if ($horasalida == '') echo "disabled"; ?>>
													</div>
													<div class="col-md-1 col-sm-1">
														<input type="number" class="form-control" min="0" max="59" id="minutosalida" name="minutosalida" value="" <?php if ($minutosalida == '') echo "disabled"; ?>>
													</div>
