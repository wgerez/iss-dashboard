...
@section('cuerpo')
  ...
  <div class="form-group" align='center'>
    <small>
      ...
      FP = Ficha de Preinscripción | FT = Fotocopia Título Secundario o Constancia de Título en Trámite | CT = Constancia de Trabajo | S = Seguro | FVS = Fecha Vencimiento Seguro
    </small>
    </div>
