...
if (isset($regularidad)) {
	...
	$calificacion = $regularidad->calificacion;
	$recuperatorio = $regularidad->recuperatorio;
	$regularizo = $regularidad->regularizo;
					...
					<div class="portlet">
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="{{url('regularidades/listado')}}" {{ $disabled }} class="btn default blue-stripe">
						...
						<div class="portlet-body form">
							<div class="form-body">
										...
										<select name="cboDocente" id="cboDocente" class="table-group-action-input form-control" readonly>
											...
											@if (isset($docentes))
												@foreach ($docentes as $docente)
													<option value="{{$docente['idt']}}" <?php if ($docente['idt'] == $docente_id) echo "selected"; ?>>{{$docente['apeynomt']}}</option>
													<option value="{{$docente['idp']}}" <?php if ($docente['idp'] == $docente_id) echo "selected"; ?>>{{$docente['apeynomp']}}</option>
													<option value="{{$docente['ids']}}" <?php if ($docente['ids'] == $docente_id) echo "selected"; ?>>{{$docente['apeynoms']}}</option>
												@endforeach
											@endif
										</select>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-2">
										<select name="cboParcial" id="cboParcial" class="table-group-action-input form-control" readonly>
											<option value="0">-</option>
											<option value="1" <?php if ($parcial == 1) echo "selected"; ?>>1</option>
											<option value="2" <?php if ($parcial == 2) echo "selected"; ?>>2</option>
											<option value="3" <?php if ($parcial == 3) echo "selected"; ?>>3</option>
										</select>
									</div>
									...
									<div class="col-md-2 <?php if ($errors->has('cboNota')) echo 'has-error' ?>">
										<select name="cboNota" id="cboNota" class="table-group-action-input form-control" <?php if ($promocional == 1) echo "disabled"; ?>>
											<?php if ($calificacion == 1) { ?>
												<option value="1" <?php if ($nota == 0) echo "selected"; ?>>-</option>
												...
												<option value="6" <?php if ($nota == 6) echo "selected"; ?>>6</option>
												<option value="7" <?php if ($nota == 7) echo "selected"; ?>>7</option>
												<option value="8" <?php if ($nota == 8) echo "selected"; ?>>8</option>
												<option value="9" <?php if ($nota == 9) echo "selected"; ?>>9</option>
												<option value="10" <?php if ($nota == 10) echo "selected"; ?>>10</option>
											<?php } ?>
										</select>
										<!-- mostrar cuando exista error -->
									...
									<input class="form-control" name="promocion" id="promocion" type="hidden" value="{{$promocional}}" readonly>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-2 col-sm-2">
										<select name="cboCalificacion" id="cboCalificacion" class="table-group-action-input form-control">
											<option value="0">-</option>
											<option value="1" <?php if ($calificacion == 1) echo "selected"; ?>>Aprobó</option>
											<option value="2" <?php if ($calificacion == 2) echo "selected"; ?>>Desaprobó</option>
											<option value="3" <?php if ($calificacion == 3) echo "selected"; ?>>Ausente</option>
										</select>
									</div>
									...
									<div class="@if ($errors->has('observaciones')) {{'has-error'}} @endif">
										...
										<div class="col-md-5 col-sm-10">
											...
											value="<?php if (isset($observaciones)) echo $observaciones; ?>"><?php if (isset($observaciones)) echo $observaciones; ?></textarea>
								...
								<div class="form-group">
									...
									<div class="col-md-2">
										<select name="cboRecuperatorio" id="cboRecuperatorio" class="table-group-action-input form-control">
											<option value="0">-</option>
											<option value="1" <?php if ($recuperatorio == 1) echo "selected"; ?>>1</option>
											<option value="2" <?php if ($recuperatorio == 2) echo "selected"; ?>>2</option>
										</select>
									</div>
									...
									<div class="col-md-2 col-sm-2">
										<select name="cboRegularizo" id="cboRegularizo" class="table-group-action-input form-control">
											<?php if ($parcial == 1) { ?>
												<option value="0" <?php if ($regularizo == 0) echo "selected"; ?>>-</option>
											<?php } ?>
											<?php if ($parcial == 2) { ?>
												<option value="0" <?php if ($regularizo == 0) echo "selected"; ?>>-</option>
												<option value="1" <?php if ($regularizo == 1) echo "selected"; ?>>SI</option>
												<option value="2" <?php if ($regularizo == 2) echo "selected"; ?>>NO</option>
												<option value="3" <?php if ($regularizo == 3) echo "selected"; ?>>PROMOCIONÓ</option>
											<?php } ?>
											<?php if ($parcial == 3) { ?>
												<option value="0" <?php if ($regularizo == 0) echo "selected"; ?>>-</option>
												<option value="1" <?php if ($regularizo == 1) echo "selected"; ?>>SI</option>
												...
												@foreach ($regularidades as $regularidad)
													...
													if ($regularidad->id == $idaseguir) { 
														...
														<tr>
															...
															<td>
																<center>
																	<a href="#" @if (!$eliminar) {{'DISABLED'}} @endif data-id="{{ $regularidad->id }}" class="btn default btn-xs red btnEliminarMaterias"><i title="Eliminar" class="fa fa-trash-o"></i></a>
																</center>
															</td>
														</tr>
													<?php } ?>
