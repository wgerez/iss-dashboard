				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-copy"></i> Pago de Cuotas
							</div>
							<div class="actions">
								...
								<a href="historial" class="btn default blue-stripe" id="btnHistorial">
								...
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											{{ Form::select('cboOrganizacion', $organizaciones, Input::old('organizacion'), array('class'=>'table-group-action-input form-control','id'=>'cboOrganizacion', $readonly)); }}
										</div>
									</div>
									<div class="form-group @if ($errors->has('txtalumno')) {{'has-error'}} @endif">
										...
										<div class="col-md-4 col-sm-4 <?php if ($errors->has('txtalumno')) echo 'has-error' ?>">
											<input class="form-control" name="txtalumno" id="txtalumno" type="text" value="{{ Input::old('txtalumno') }}">
									...
									<input class="form-control" name="txt_pago_id" id="txt_pago_id" type="hidden" value="0">
									<div class="@if ($errors->has('txt_alumno_id')) {{'has-error'}} @endif">
										<div class="col-md-4 col-sm-4 <?php if ($errors->has('txt_alumno_id')) echo 'has-error' ?>">
											<input class="form-control" name="txt_alumno_id" id="txt_alumno_id" type="hidden" value="{{ Input::old('txt_alumno_id') }}">
											@if ($errors->has('txt_alumno_id'))
											    <span class="help-block">{{ $errors->first('txt_alumno_id') }}</span>
										    @endif
										</div>
									</div>
									<div class="@if ($errors->has('txt_inscripcion_id')) {{'has-error'}} @endif">
										<div class="col-md-4 col-sm-4 <?php if ($errors->has('txt_inscripcion_id')) echo 'has-error' ?>">
											<input class="form-control" name="txt_inscripcion_id" id="txt_inscripcion_id" type="hidden" value="{{ Input::old('txt_inscripcion_id') }}">
											@if ($errors->has('txt_inscripcion_id'))
											    <span class="help-block">{{ $errors->first('txt_inscripcion_id') }}</span>
										    @endif
										</div>
									</div>
									<div class="@if ($errors->has('txt_persona_id')) {{'has-error'}} @endif">
										<div class="col-md-4 col-sm-4 <?php if ($errors->has('txt_persona_id')) echo 'has-error' ?>">
				  							<input id="txt_persona_id" name='txt_persona_id' type="hidden" value="{{ Input::old('txt_persona_id') }}">
											@if ($errors->has('txt_persona_id'))
											    <span class="help-block">{{ $errors->first('txt_persona_id') }}</span>
										    @endif
										</div>
									</div>
									<div class="form-group @if ($errors->has('cboCiclo')) {{'has-error'}} @endif">
										<label  class="col-md-2 col-sm-2 control-label">Ciclo Lectivo:</label>
										<div class="col-md-2 col-sm-2 <?php if ($errors->has('cboCiclo')) echo 'has-error' ?>">
											{{ Form::select('cboCiclo', array(), Input::old('cboCiclo'), array('class'=>'table-group-action-input form-control','id'=>'cboCiclo')); }}
											@if ($errors->has('cboCiclo'))
											    <span class="help-block">{{ $errors->first('cboCiclo') }}</span>
										    @endif
										</div>
									</div>
								</div>
					...
					<div class="portlet form-horizontal">
						...
						<div class="portlet">
							...
							<div class="form-group">
								...
								<input class="form-control" name="txt_matricula_id" id="txt_matricula_id" type="hidden" value="">
								...
								<div class="col-md-2 col-sm-2">
									<input type="number" class="form-control" id="txt_descuento" name="txt_descuento" value="" readonly>
							...
							<div class="form-group">
								...
								<div class="col-md-2 col-sm-2">
									<input type="number" class="form-control" id="txt_recargo" name="txt_recargo" value="" readonly>
								...
								<div class="col-md-2 col-sm-2">
									<a class="btn blue-madison" id='btnImprimir'>
							...
							<div class="form-group">
								<label class="col-md-1 col-sm-1 control-label"><strong>TOTAL</strong></label>
						 		<div class="input-icon col-md-10 col-sm-10">
									<input type="text" name="txt_total_pagar" id="txt_total_pagar" placeholder="" class="form-control" value='' style="text-align:right" readonly>
									<input type="hidden" name="txt_total_apagar" id="txt_total_apagar" placeholder="" class="form-control" value='0'>
								</div><br>
							</div>
						</div>
						...
						<div class="portlet">
							...
							<div class="form-group @if ($errors->has('txt_efectivo')) {{'has-error'}} @endif">
								...
								<div class="col-md-2 <?php if ($errors->has('txt_efectivo')) echo 'has-error' ?>">
									<input type="number" class="form-control" id="txt_efectivo" name="txt_efectivo" value="{{ Input::old('txt_efectivo') }}" placeholder="Efectivo">
							...
							<div class="form-group @if ($errors->has('txt_tarjeta')) {{'has-error'}} @endif">
								...
								<div class="col-md-2 <?php if ($errors->has('txt_tarjeta')) echo 'has-error' ?>">
									<input type="number" class="form-control" id="txt_tarjeta" name="txt_tarjeta" value="{{ Input::old('txt_tarjeta') }}" placeholder="Tarjeta de Credito">
							...
							<div class="form-group @if ($errors->has('txt_debito')) {{'has-error'}} @endif">
								...
								<div class="col-md-2 <?php if ($errors->has('txt_debito')) echo 'has-error' ?>">
									<input type="number" class="form-control" id="txt_debito" name="txt_debito" value="{{ Input::old('txt_debito') }}" placeholder="Tarjeta de Debito">
							...
							<div class="form-group @if ($errors->has('txt_bancaria')) {{'has-error'}} @endif">
								...
								<div class="col-md-2 <?php if ($errors->has('txt_bancaria')) echo 'has-error' ?>">
									<input type="number" class="form-control" id="txt_bancaria" name="txt_bancaria" value="{{ Input::old('txt_bancaria') }}" placeholder="Cuenta Bancaria">
							...
							<div class="form-group @if ($errors->has('txt_cheque')) {{'has-error'}} @endif">
								...
								<div class="col-md-2 <?php if ($errors->has('txt_cheque')) echo 'has-error' ?>">
									<input type="number" class="form-control" id="txt_cheque" name="txt_cheque" value="{{ Input::old('txt_cheque') }}" placeholder="Cheque">
...
@section('customjs')
    ...
    $('#btnHistorial').attr('disabled', 'disabled');
	...
	$('#btnImprimir').on('click', function(e){
		e.preventDefault();
		window.open("{{url('cuotas/imprimirrecibo')}}?inscripcion_id=" + $('#txt_inscripcion_id').val() + '&matricula_id=' + $('#txt_matricula_id').val());
	});

	$('#btnHistorial').on('click', function(e){
		e.preventDefault();
		window.open("{{url('cuotas/historial')}}?ciclo_id=" + $('#cboCiclo').val() + '&dni=' + $('#txtalumno').val());
	});
    ...
    $('#cboCiclo').change(function() {
		...
		$.ajax({
		  ...
		  type: 'POST'
	    	...
	    	if (carreras == 'El alumno no posee carrera inscriptas!') {
	    	...
	    	if (carreras == 'El alumno no tiene abonada la matricula de este ciclo!') {
	    		$('#divMensaje').html('<p class="form-control-static"><h4>' + carreras + '</h4></p>');
	    		$('#MensajeCantidad').modal('show');
	    		$('#cboCiclo').removeAttr("disabled");
	    	    return;
			...
			$.each(carreras, function(key, value) {
    			...
    			$('#btnHistorial').removeAttr("disabled");
			});
		}).error(function(data) {
			console.log(data);
		});
