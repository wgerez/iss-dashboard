...
class CreateDetallesmatriculaspagosTable extends Migration {
	...
	public function up()
	{
		Schema::create('detallesmatriculaspagos', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('detallesmatriculaspagos');
	}
