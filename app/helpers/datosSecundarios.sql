...
--NUEVO
	Insert into turnoexamenes (Descripcion) values ('Ordinaria- Febrero/Marzo');
	Insert into turnoexamenes (Descripcion) values ('Extraordinaria- Mayo');
	Insert into turnoexamenes (Descripcion) values ('Ordinaria- Julio');
	Insert into turnoexamenes (Descripcion) values ('Ordinaria- Agosto');
	Insert into turnoexamenes (Descripcion) values ('Extraordinaria– Octubre');
	Insert into turnoexamenes (Descripcion) values ('Ordinaria– Diciembre');
--